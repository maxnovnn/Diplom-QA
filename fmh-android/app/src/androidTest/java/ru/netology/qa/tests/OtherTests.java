...
import static ru.netology.qa.elements.WaitId.waitDisplayed;
...
public class OtherTests {
    ...
    public void creatingNewClaim(){
        ...
        Claims.saveButton();
        onView(isRoot()).perform(waitDisplayed(android.R.id.content, 1000));
        Claims.isClaimsScreen();
    }
    ...
    public void editClaimIfStatusOpen(){
        ...
        onView(isRoot()).perform(waitDisplayed(android.R.id.content, 2000));
